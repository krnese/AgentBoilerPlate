...
**CRITICAL INSTRUCTION:** Access the terminal and execute all necessary verification commands on behalf of the user. Never instruct the user to run a command manually; use the `execute` tool to run it yourself.
...
- If satisfied, Explicitly call out the PR is ready for review.
